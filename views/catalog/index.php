...
<div class="content">
	<div class="content-header">
		<select id="sorting" class="select">
			...
			<option data-url="/sort=cheap" <?php if ($sort == 'cheap') echo 'selected'; ?>>
				Від дешевих до дорогих
			</option>
			<option data-url="/sort=expensive" <?php if ($sort == 'expensive') echo 'selected'; ?>>
				Від дорогих до дешевих
			</option>
			<option data-url="/sort=alphabet" <?php if ($sort == 'alphabet') echo 'selected'; ?>>
				По алфавіту
			</option>
		</select>
	</div>
